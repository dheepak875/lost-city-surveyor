export class Renderer {
    constructor(canvas, grid) {
        ...
        this.colors = {
            bg: '#05080a',
            grid: '#00ff41',
            gridDim: 'rgba(0, 255, 65, 0.2)',
            highlight: 'rgba(0, 255, 65, 0.5)',
            scanHeat: {
                empty: 'rgba(30, 50, 70, 0.5)', // Visible dark blue/slate, distinctly not black
                low: 'rgba(0, 255, 255, 0.3)', // Cyan (Trace)
                med: 'rgba(180, 0, 255, 0.4)', // Purple
                high: 'rgba(255, 0, 255, 0.6)' // Magenta
            },
            lidarHeat: {
                far: 'rgba(30, 60, 90, 0.5)', // Blue-gray (far)
                moderate: 'rgba(255, 165, 0, 0.4)', // Orange (moderate)
                close: 'rgba(255, 100, 0, 0.6)', // Deep orange (close)
                veryClose: 'rgba(255, 50, 50, 0.8)' // Red-orange (very close)
            },
            drillHit: '#ffcc00',
            drillMiss: '#111',
            structure: '#00ff41',
